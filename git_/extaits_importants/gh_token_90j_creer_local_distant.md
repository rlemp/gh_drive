# comment lier un dossier local a un compte github prive
...
# comment générer un **jeton d'accès personnel (PAT)** sur GitHub si vous rencontrez des problèmes d'authentification ?
